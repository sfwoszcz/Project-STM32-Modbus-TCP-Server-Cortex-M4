...
FC24 reads a non-destructive snapshot from an application-owned FIFO register
block. The response includes a two-byte Byte Count, FIFO Count, and up to 31
queued register values. See
...
│   ├── test_modbus_fc24.c    Dedicated FC24 FIFO/TCP/RTU/master tests
...
├── modbus-fc23.md
├── modbus-fc24-read-fifo-queue.md
...
FC0F, FC10, FC11, FC20, FC21, FC22, FC23, FC24, and FC43/14 request ADUs and validates one complete response against
